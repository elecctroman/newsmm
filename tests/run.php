...
if (in_array('sqlite', PDO::getAvailableDrivers(), true)) {
    ...
    expectEquals('/media/test-left.jpg', $heroLayout['left_banner']['image_url'], 'fetchHeroLayout keeps primary left banner');
    expectEquals('/media/test-right.jpg', $heroLayout['right_banner']['image_url'], 'fetchHeroLayout keeps primary right banner');
