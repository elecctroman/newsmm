        ...
        carousels.forEach(function (carousel) {
            ...
            function handleKeydown(event) {
                if (event.key === 'ArrowLeft') {
                    ...
                    goToSlide(currentIndex - 1, { focusDot: true });
                    restartAutoplay();
            ...
            function endPointerGesture() {
                if (pointerIdentifier !== null) {
                    try {
                        carousel.releasePointerCapture(pointerIdentifier);
                    } catch (err) {
                ...
                pointerDeltaX = 0;
                pointerStartX = 0;
                window.setTimeout(resumeAutoplay, 160);
            }
            ...
            carousel.addEventListener('pointermove', function (event) {
                if (!pointerActive || event.pointerId !== pointerIdentifier) {
                    return;
                }
