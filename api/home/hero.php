...
$leftBanners = $layout['left_banners'] ?? [];
$rightBanners = $layout['right_banners'] ?? [];
...
$payload = [
    'leftBanner' => $mapBanner($leftBanners[0] ?? null),
    'leftBanners' => array_values(array_filter(array_map($mapBanner, $leftBanners))),
    'mainSlides' => array_values(array_map($mapSlide, $slides)),
    'rightBanner' => $mapBanner($rightBanners[0] ?? null),
    'rightBanners' => array_values(array_filter(array_map($mapBanner, $rightBanners))),
