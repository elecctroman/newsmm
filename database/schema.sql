...
-- Legacy hero slider tables were removed in favour of dynamic home blocks.
-- Installations upgrading from earlier versions should rely on the
-- archiveAndDropLegacyHeroTables() helper to back up and remove
-- `hero_banners`, `hero_slides`, and `hero_strip_items` tables automatically.
