...
INSERT INTO categories (slug, name, description, emoji, sort_order, is_active) VALUES
('lisans', 'Lisans Hizmetleri', 'Aradığınız Tüm Lisanslar', '🧩', 1, 1),
('twitter', 'Twitter Hizmetleri', '2007–2025 Hesaplar', '🐦', 2, 1),
('instagram', 'Instagram Hizmetleri', 'Takipçili Takipçisiz Eski Hesaplar', '📸', 3, 1)
